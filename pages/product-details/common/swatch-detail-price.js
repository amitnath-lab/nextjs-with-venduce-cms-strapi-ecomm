    ...
    <>
      <div className={`product-right ${params.stickyClass}`}>
        ...
        <ul class="image-swatch">
          <li class="active">
            <a href="#">
              <img src={img1} alt="" class="img-fluid blur-up lazyloaded" />
            </a>
          </li>
          <li>
            <a href="#">
              <img src={img2} alt="" class="img-fluid blur-up lazyloaded" />
            </a>
          </li>
          <li>
            <a href="#">
              <img src={img3} alt="" class="img-fluid blur-up lazyloaded" />
            </a>
          </li>
        </ul>
